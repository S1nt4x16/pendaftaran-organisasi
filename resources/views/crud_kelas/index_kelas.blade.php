        ...
        <table id="table-kelas">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $k->created_at }}</td>
                    <td>
                        <a href="{{ url('/kelas/edit/'.$k->id) }}" class="btn btn-success">Edit</a>
                        <button type="button" class="btn btn-danger" data-coreui-toggle="modal"
                            data-coreui-target="#hapus" data-coreui-name="{{ $k->kelas }}"
                            data-coreui-url="{{ url('kelas/delete/'.$k->id) }}">Delete</button>
                    </td>
                </tr>
                @endforeach
            </tbody>
