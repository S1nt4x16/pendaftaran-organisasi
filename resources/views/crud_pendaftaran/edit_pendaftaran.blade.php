                    ...
                    <form action="{{ url('/pendaftaran/update') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nama_lengkap" 
                                value="{{ $pf->nama_lengkap }}" id="exampleInputPassword1">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Tempat Lahir</label>
                            <input type="text" class="form-control" name="tempat_lahir" 
                                value="{{ $pf->tempat_lahir }}" id="exampleInputPassword1">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Tanggal Lahir</label>
                            <input type="date" class="form-control" name="tanggal_lahir" 
                                value="{{ $pf->tanggal_lahir }}" id="exampleInputPassword1">
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="jenis_kelamin" 
                                ...
                                <option value="L" {{ $pf->jenis_kelamin=='L' ? 'selected' : '' }}>
                                    L
                                </option>
                                <option value="P" {{ $pf->jenis_kelamin=='P' ? 'selected' : '' }}>
                                    P
                                </option>
                            </select>
                        </div>
                        <div class="mb-2">
                            ...
                            <select class="form-select" name="agama" 
                                ...
                                <option value="">--Pilih--</option>
                                @foreach($agama as $a)
                                <option value="{{ $a->id }}" {{ $pf->id_agama == $a->id ? 'selected' : '' }}>
                                    {{ $a->agama }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-select" name="kelas" aria-label="Default select example">
                                <option value="">--Pilih--</option>
                                @foreach($kelas as $k)
                                <option value="{{ $k->id }}" {{ $pf->id_kelas == $k->id ? 'selected' : '' }}>
                                    {{ $k->kelas }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-select" name="walas" 
                                ...
                                <option value="">--Pilih--</option>
                                @foreach($walas as $w)
                                <option value="{{ $w->id }}" {{ $pf->id_walas == $w->id ? 'selected' : '' }}>
                                    {{ $w->walas }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-select" name="divisi" 
                                ...
                                <option value="">--Pilih--</option>
                                @foreach($divisi as $d)
                                <option value="{{ $d->id }}" {{ $pf->id_divisi == $d->id ? 'selected' : '' }}>
                                    {{ $d->divisi }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="alasan" 
                                value="{{ $pf->alasan }}" id="exampleInputPassword1">
                        </div>
                        <div class="mb-2">
                            ...
                            <select class="form-select" name="izin_ortu" 
                                ...
                                <option value="{{ $io->id }}" {{ $pf->id_izin_ortu == $io->id ? 'selected' : '' }}>
                                    {{ $io->izin_ortu }}
                                </option>
                                @endforeach
                            </select>
